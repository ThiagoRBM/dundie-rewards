...
#from dundie import cli ## cada bibliteca instalada (dundie foi instalada) é um namespace e dá para chamar na hora de importar (esse é um import absoluto)
from dundie.cli import main ## import só a funcao main
#from .cli import main ## import só a funcao main, import RELATIVO (pega na mesma pasta com o ".")
